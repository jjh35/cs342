...
public class HelloKVLite {
    ...
    public static void main(String[] args) {
        ...
        String myValueString = "Jesse Hulse"; String myKeyString = "2129126";
        Key myKey = Key.createKey(Arrays.asList(myKeyString));
        Value myValue = Value.createValue(myValueString.getBytes());
        store.put(myKey, myValue);

        //Read
        result = new String(store.get(myKey).getValue().getValue());
        System.out.println(myKey.toString() + " : " + result);

        //Update
        valueString = "Lionel Messi";
        value = Value.createValue(valueString.getBytes());
        ...
        HelloRecords hr = new HelloRecords();
    }
